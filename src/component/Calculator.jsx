  ...
  return (
    <div className="calculator">
      ...
      <div className="buttons">
        ...
        <button onClick={() => setDisplay(prevDisplay => prevDisplay.slice(0, -1))}className='clear'><i class="fa-solid fa-delete-left"></i></button>
        ...
        <button onClick={() => handleClick('.')}>.</button>
        <button onClick={() => handleClick('+')}>+</button>
        <button onClick={calculate}className='active'>=</button>
